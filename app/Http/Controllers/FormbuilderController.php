...
class FormbuilderController extends Controller
{
    ...
    {
        $forms = formBuilder::with('response')->get();
    ...
    public function show(Request $request, $id)
    {
        ...
        if (!$form && $fieldTypes ) {
            return redirect()->route('formBuilder.index')->with('error', 'Form not found.');
        }

        return view('formBuilder.show', compact('form', 'fieldTypes', 'formFields'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validated && !empty($validated)) {
            ...
            return redirect()->route('form_builder')->with('success', 'form has been updated successfully.');
        } else {
    ...
    public function viewForm($id)
    {
        ...
        if ($form) {
                ...
                return view('formBuilder.show_form', compact('formFields', 'id', 'form'));
    ...
    public function editFormField( $id)
    {
        ...
        if(!empty($types))
        {
            ...
            return view('formBuilder.edit_form_field', compact( 'types', 'form'));
        }
        else
        {
    ...
    public function updateFormField()
    {
        ...
        try {
            ...
            return redirect()->route('formBuilder.show', $id);
    ...
    public function storeResponse (Request $request, $id): RedirectResponse
    {
        ...
        if(!empty($form))
        {
            ...
            return redirect()->route('formBuilder.index')->with('success', 'Response submited successfully.');
        }
        else
        {
            return redirect()->route('formBuilder')->with('error', 'Failed to save response. Please try again.');
        }
    }
    ...
    public function viewDetailResponse($id)
    {
        ...
        return view('formBuilder.response_detail', compact('formField', 'responses', 'data', 'formBuilder'));
    }
    
    public function thankYou()
    {
        return view ('formBuilder.thank_you');
    }
