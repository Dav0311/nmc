...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>NMC Point of Sales System</title>
    ...
    <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="../backend/index.html" class="header-logo">
                  <img src="../assets/images/logo.png" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">NMC</h5>
              </a>
              ...
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                      ...
                      <a href="../backend/index.html" class="header-logo">
                          ...
                          <h5 class="logo-title ml-3">NMC</h5>
...
document.getElementById('saleForm').addEventListener('submit', function(event) {
    ...
    document.querySelector('#itemsTable tbody').innerHTML += newRow;
...
function updateGrandTotal() {
    ...
    // Loop through each row in the table body and sum up the "Total Amount" values
    document.querySelectorAll('#itemsTable tbody tr').forEach(function(row) {
        const totalAmount = parseFloat(row.cells[2].textContent);
...
// Calculate total dynamically when price or quantity is changed
