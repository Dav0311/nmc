...
<div class="content">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <div class="row">
                <form class="row gx-3 gy-2 align-items-center" action="{{ route('update_categories', $category->id) }}" method="post">
                    @csrf
                    @method('PUT')

                    <div class="col-sm-3">
                        <label class="visually-hidden" for="specificSizeInputName">Name</label>
                        <input type="text" name="name" class="form-control" id="specificSizeInputName" value="{{ old('name', $category->name) }}">
                    </div>
